      ...
      <form method="POST" action="staff_edit_check.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            ...
            <?PHP elseif (isset($_SESSION['staff']["user_name"]) && $_SESSION['staff']["user_name"]):?>
              <input type="text" class="form-control col-form-label" id="user_name" name="user_name" value="<?=$_SESSION['staff']["user_name"]?>">
            <?php else:?>
